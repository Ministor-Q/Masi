...
<head>
  ...
  <body >
   ...
   <div class="fd_content">
	...
	<div class="fd_main">
		...
		<div class="xwgg_title"><a href="XyjjAction">学院简介</a></div>
		<div class="xwgg_title"><a href="JgszAction">机构设置</a></div>
		</div>
		...
		<div class="fd_dl_01">
					...
					<span style="letter-spacing: 2px;line-height:24px;">${sessionScope.XyjjArticle}</span>						
					</div>
				</div>
		</div>
	</div>
 ...
 <!--<div class="fd_main">
  <h2 class="fd_h2_bnav ">
   <a href="homepageAction">首页</a>
   <span class="fd_separate">-</span>
   <a href="">学院概况</a>
   <span class="fd_separate">-</span>
   <span class="current_location">学院简介</span>
  </h2>
  <div class="fd_layout_row fd_mb15" style="margin-top:-50px ;overflow: hidden;word-wrap:break-word;word-break:normal;" >
  <span style="text-align: center;font-weight: bold;font-size: 18px;"><h1>${sessionScope.XyjjTitle}</h1></span>
   <pre id="xyjjArticle" >
   ${sessionScope.XyjjArticle}
