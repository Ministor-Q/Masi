  ...
  <body onload = "loadSzdwPic()">
   ...
   <div class="fd_content">
	<div class="fd_main">
		...
		<div class="fd_dl_01">
					...
					<div class="dd_con  dd_con_ie6">
						...
						<c:forEach items="${list}" var="szdw">
							<div class = "fd_news_list_main" style="float:left;margin-left:15px;text-align: center;">
							<a href ="OpenArticleAction?code=${szdw.szdwcode}"><img src="${szdw.szdwpicaddr}" alt="${szdw.szdwpicaddr}" width="220px" height="300px"><br>
							<span style="font-weight: bold;">${szdw.szdwname}</span>
							</a>
							</div>
	...
	<!-- fd_main end -->
    	...
    	<c:forEach items="${list}" var="szdw">
        <input class="szdwimg" type="button" value="${szdw.szdwpiccode}" style="display:none;">
    </c:forEach>
...
<script type="text/javascript" src="../../scripts/szdw.js"></script>
