  ...
  <body >
   ...
   <div class="fd_content">
	<div class="fd_main">
		...
		<div class="fd_main_content2" style="word-break:breakall;word-wrap:break-word;min-height: 500px;padding: -20px 10px 0 10px;">
		<span style="letter-spacing: 2px;line-height:24px;">${article}</span>
