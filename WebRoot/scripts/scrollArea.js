											...
											scrollUl.stop(true,true).animate({
													...
													function(){
														for(var i=0; i<opts.step; i++){
															scrollUl.children("li:first").appendTo(scrollUl)	;
														};	
														scrollUl.css({
																"left":0
															})
															//  为第一个添加选中样式
															.children("li:first").addClass(opts.selectedClass).siblings().removeClass(opts.selectedClass); 
